...
android {
    ...
    defaultConfig {
        ...
        buildConfigField(
            ...
            "\"${customizationValue("GOOGLE_OAUTH_CLIENT_ID")}\""
        )
        buildConfigField(
            "String",
            "GOOGLE_OAUTH_CLIENT_SECRET",
            "\"${customizationValue("GOOGLE_OAUTH_CLIENT_SECRET")}\""
        )
        ...
        buildConfigField(
            ...
            "\"${customizationValue("ANTIGRAVITY_OAUTH_CLIENT_ID")}\""
        )
        buildConfigField(
            "String",
            "ANTIGRAVITY_OAUTH_CLIENT_SECRET",
            "\"${customizationValue("ANTIGRAVITY_OAUTH_CLIENT_SECRET")}\""
        )
